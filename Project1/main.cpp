...
int main() {
    ...
    std::cout << _xor_("Hello.") << std::endl;
    std::cout << _xor_("The hardware counterfeiting process begins.") << std::endl;
    ...
    system(_xor_("cls").c_str());
    std::cout << _xor_("Counterfeiting process is about to finish.") << std::endl;
